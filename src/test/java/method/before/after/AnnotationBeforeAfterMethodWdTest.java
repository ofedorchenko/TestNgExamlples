package method.before.after;

import org.openqa.selenium.WebDriver;
import org.openqa.selenium.firefox.FirefoxDriver;
import org.testng.annotations.*;

public class AnnotationBeforeAfterMethodWdTest {
    ...
    public void annotationAfterTest() {
        driver.quit();
        System.out.println("Успешное выполнение метода - annotationAfterMethod после каждого метода с аннотацией @Test");
    }
}
