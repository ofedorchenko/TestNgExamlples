...
public class AnnotationBeforeAfterWdTest {
    ...
    public void annotationAfterTest() {
        driver.quit();
        System.out.println("Успешное выполнение метода - annotationAfterTest после методов: startFirefoxGoToGooglePageOne и startFirefoxGoToGooglePageTwo");
    }
}